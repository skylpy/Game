...
- (void)viewDidLoad {
    ...
    for (int i = 0; i < 18; i ++) {
        ...
        NSString * randomStr = [NSString stringWithFormat:@"stone_%d",random];
        [nmArray addObject:randomStr];
        [nmArray addObject:randomStr];
        
    }
    
    CGFloat top = ([UIScreen mainScreen].bounds.size.height - 150)-[UIScreen mainScreen].bounds.size.width;
    for (int i = 0; i < 6; i ++) {
        ...
        for (int j = 0;j < 6; j ++) {
            ...
            btn.frame = CGRectMake(j * [UIScreen mainScreen].bounds.size.width/6,top + i * [UIScreen mainScreen].bounds.size.width/6, [UIScreen mainScreen].bounds.size.width/6, [UIScreen mainScreen].bounds.size.width/6);
